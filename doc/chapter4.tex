...
In a center specialized in the treatment of patients affected by NDD a therapist named Erica is looking for some new activities to entertain her patients Marco and Giulio.
Since the patients would like to have an "SAM Activities" is already being installed on the pc of the Magic Room of the center where she works, so she decides to try it for the first time.
Firstly she goes on the website and register, then she adds Marco's and Giulio's records by inserting name, surname, date of birth, type of disability and a comment