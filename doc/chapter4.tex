...
%\begin{figure}[h!]
%	\includegraphics[width=\textwidth]{images/UX/unity/run/3-powerUp}
%	\caption{Power up chest}
%	\label{fig:unityRunPowerUp}
%\end{figure}
...
\begin{itemize}
	\begin{figure}[h!]
		\includegraphics[width=\textwidth]{images/UX/unity/search/1-searchZone}
	...
	\begin{figure}[h!]
			\includegraphics[width=\textwidth]{images/UX/unity/search/2-magnifierRequest}
